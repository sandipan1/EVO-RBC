...
def main(num_iterations,save_freq,visualise,load_path,num_processes):
	...
	map_elites.generate_repertoire(num_iterations=num_iterations,save_dir=save_dir,save_freq=save_freq,visualise=visualise,mutation_stdev=0.05,num_processes=num_processes)
